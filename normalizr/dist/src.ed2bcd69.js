...
},{"./schemas/Entity":10,"./schemas/Union":11,"./schemas/Values":12,"./schemas/Array":13,"./schemas/Object":14,"./schemas/ImmutableUtils":15}],2:[function(require,module,exports) {
"use strict";
...
fetch("https://api.myjson.com/bins/y355u").then(function (res) {
  return res.json();
}).then(function (res) {
  console.log(res);
  var data = (0, _normalizr.normalize)(res, [studentSchema]);
  console.log(data);
});
},{"normalizr":9}],12:[function(require,module,exports) {
...
//# sourceMappingURL=/src.ed2bcd69.map